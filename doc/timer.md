...
|总线接口    |cs_       |输入端口       |wire                |1    |片选|
|总线接口    |as_       |输入端口       |wire                |1    |地址选通|
|总线接口    |rw        |输入端口       |wire                |1    |读/写|
|总线接口    |addr      |输入端口       |wire                |2    |地址|
|总线接口    |wr_data   |输入端口       |wire                |32   |数据写入|
|总线接口    |rd_data   |输出端口       |reg                 |32   | 数据读取|
|总线接口    |rdy_      |输出端口       |reg                 |1    | 就绪信号|
|控制寄存器 0|mode      |内部信号 reg 1 |控制寄存器 0 :模式位|     ||
